    ...
    <>
      ...
      <div id="Earpodbelow">
        <div id="line3-4Handset">
          ...
          <div id="HandsetSeries">Earpods</div> <div id="line4Handset"></div>
        </div>

        <div id="scroll-containerHandset">
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={0} descno={0} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={1} descno={1} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={2} descno={2} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={3} descno={3} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={4} descno={4} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={5} descno={5} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={6} descno={6} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={7} descno={7} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={8} descno={8} />{" "}
          </div>
          <div id="boxHandset">
            {" "}
            <EarpodCont imagenosent={9} descno={9} />{" "}
          </div>
        </div>
